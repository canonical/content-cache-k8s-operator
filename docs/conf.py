...
html_context = {
    ...
    "product_page": "charmhub.io/content-cache-k8s",
    ...
    "github_url": "https://github.com/canonical/content-cache-k8s-operator",
...
#
html_theme_options = {
    'source_edit_link': 'https://github.com/canonical/content-cache-k8s-operator',
}
